...
//
//levelTwoView.m implements the spot actions for the first level of the game
//
...
- (void)viewDidLoad {
    ...
    pos1 = CGPointMake(7.0,5.0);
    pos2 = CGPointMake(7.0,5.0);
    pos3 = CGPointMake(7.0,5.0);
    pos4 = CGPointMake(7.0,5.0);
    pos5 = CGPointMake(7.0,5.0);
    pos6 = CGPointMake(7.0,5.0);
    pos7 = CGPointMake(7.0,5.0);
    pos8 = CGPointMake(7.0,5.0);
    pos9 = CGPointMake(7.0,5.0);
    pos10  = CGPointMake(7.0,5.0);
    
    //the different spot images
    ...
    //timer to make it look like the spots are continously moving
    [NSTimer scheduledTimerWithTimeInterval:0.05 target:self selector:@selector(onTimer) userInfo:nil repeats:YES];
    
    //set up individual timers for each spot 3 seconds apart
...
-(void)timesUp4{
    ...
    if(count==3)
    {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Loser"
                                                        message:[NSString stringWithFormat:@"You lost level 2"]
                                                       delegate:self
...
-(void)timesUp{
    ...
    if(count==3)
    {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Winner"
                                                        message:[NSString stringWithFormat:@"You beat the Game!"]
                                                       delegate:self
                                              cancelButtonTitle:@"Start Over"
                                              otherButtonTitles:nil];
        [alert show];
...
//redirect the user to start of game when they press the Start Over button
